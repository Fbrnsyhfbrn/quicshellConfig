...
Scope {
    ...
    readonly property real widgetWidth: 378
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            ...
            margins {
                ...
                left: Config.options.bar.vertical ? Appearance.sizes.barHeight : ((mediaControlsRoot.screen.width / 2) - (osdWidth / 2) - widgetWidth - 320)
